export default function Review(props) {
    ...
    return(
        ...
        <div className='d-inline-flex review' style={{ 'minHeight': '172px', 'width': '100%' }}>
            <div style={{ 'width': '100%', 'minHeight': '100%' }} className='bg-white p-3 mx-auto'>
                <div style={{ 'width': '100%' }} className='d-block d-md-flex align-items-center text-center'>
                    ...
                    <div>
                        ...
                        <span className='text-gray' style={{ 'fontSize': '12px' }}>{ review.user.post ? review.user.post : '' + ' - ' + review.user.enterprise ? review.user.enterprise : review.user.location }</span>
                    </div>
                </div>
